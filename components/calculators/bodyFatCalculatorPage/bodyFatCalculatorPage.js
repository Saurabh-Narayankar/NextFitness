                ...
                <div className={classes.risks}>
                    <div className={classes.measureBodyFat}>
                        ...
                        <div className={classes.measureBodyFatDescription}>
                            ...
                            <ul>
                                <li><b>Waist circumference: </b>Measure the circumference of the subject's waist at a horizontal level around the navel for men, and at the level with the smallest width for women. Ensure that the subject does not pull their stomach inwards to obtain accurate measurements.</li>
                                <li><b>neck circumference: </b>Measure the circumference of the subject's neck starting below the larynx, with the tape sloping downward to the front. The subject should avoid flaring their neck outwards.</li>
                                <li><b>Hip circumference: </b>For women only: Measure the circumference of the subject's hips at the largest horizontal measure.</li>
                            </ul>
