                    ...
                    <div className={classes.calorie}>
                        ...
                        <div className={classes.calorieDescription}>
                            <ul>
                                ...
                                <li><b>Proteins</b>: They are organic compounds comprised of amino acids, and are one of the types of macronutrients. Amino acids are essential to a persons well-being, and there are certain amino acids that can only be obtained through diet. These amino acids are typically referred to as essential amino acids, and are obtained by humans and other animals through the consumption of protein.There are numerous sources of protein, both animal (meat, dairy, etc.) and plant-based (beans, legumes, nuts, seeds, etc.). There also exist protein supplements that are sometimes used by people who are trying to build muscle. Although protein is a necessary part of the human diet, as with most things, moderation is important.</li>
